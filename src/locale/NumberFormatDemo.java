 ...
 *
 * региональные представления чисел
 *
 *
 * производится преобразование строки, содержа-
 щей число, в три различных региональных стандарта, а затем одно из чисел
 преобразуется из одного стандарта в два других.
 *
 */
