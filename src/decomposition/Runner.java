 ...
 *
 * «десь был приведен пример простейшей декомпозиции. ѕри разработке при-
 ложений любой сложности всегда следует производить анализ предметной обла-
 сти, определ€ть абстракции и раздел€ть задачу на логические взаимодействую-
 щие части. “ем не менее границы, отдел€ющие хороший дизайн приложени€
 от посредственного, достаточно размыты и завис€т от общего уровн€ компе-
 тентности команды разработчиков и правил, прин€тых в проекте.
